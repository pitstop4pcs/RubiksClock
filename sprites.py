...
class KeyboardGraphic:
    def __init__(self, key, pos):
        if key == "return":
            ...
            pygame.draw.rect(self.surface, "black", (18, 38, 62, 42), 2, 6, 0, 0, 6, 6)
            pygame.draw.line(self.surface, "white", (20, 38), (77, 38), 2)
            pygame.draw.rect(self.surface, "black", (4, 4, 72, 32), 2, 6, 6, 6, 6, 0)
            pygame.draw.rect(self.surface, "black", (22, 34, 54, 42), 2, 6, 0, 0, 6, 6)
            pygame.draw.line(self.surface, "white", (23, 34), (73, 34), 2)
